...
class QuaggaBlockParser:
	...
	def parse_predictions(self, emails_predicted):
		emails_parsed = []
		for email_predicted in emails_predicted:
			...
			for line_prediction in email_predicted:
				top_prediction = self.top_prediction(line_prediction['predictions'])
		...
		# end for email_predicted in emails_predicted:
