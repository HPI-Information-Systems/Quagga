...
setup(
	...
	url="",
	packages=['Quagga'],
	package_data={'Quagga': ['models/*/*.json', 'models/*/*.hdf5']},
	install_requires=['absl-py==0.3.0', 'astor==0.7.1', 'autopep8==1.3.5', 'bleach==1.5.0', 'click==6.7',
	                  ...
	                  'Werkzeug==0.14.1'],
	dependency_links=['git+https://www.github.com/keras-team/keras-contrib.git@f25c26665e990cfdf1da61a3de10a34d67f74b37'],
)
